...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>YJ's Laravel REST API</title>
    ...
    <body>
        <div class="container">
            <div class="header">
                <div class="logo">🚀 Laravel REST API</div>
                <div class="subtitle">Professional API Development</div>
                <div class="author">Built by YJ</div>
                <div class="status">
            ...
            <div class="features">
                <div class="feature-card">
                    ...
                    <div class="feature-description">JWT-based authentication with role-based access control</div>
                </div>
                
                <div class="feature-card">
                    <div class="feature-title">📊 RESTful Endpoints</div>
                    <div class="feature-description">Clean, intuitive API endpoints following REST principles</div>
                </div>
                
                <div class="feature-card">
                    <div class="feature-title">📝 API Documentation</div>
                    <div class="feature-description">Comprehensive documentation for all available endpoints</div>
                </div>
                
                <div class="feature-card">
                    <div class="feature-title">⚡ High Performance</div>
                    <div class="feature-description">Optimized queries and caching for lightning-fast responses</div>
                </div>
            </div>
            
            <div class="links">
                <a href="/api/documentation" class="link">
                    📚 API Docs
                </a>
                <a href="https://github.com/YJ0411" class="link" target="_blank">
